...
public class Sign_crack {
    ...
    public static Sign_crack.SignatureData signMessage(byte[] message, ECKeyPair keyPair) {
        ...
        return new Sign_crack.SignatureData(v, r, s);
    }
    ...
    public static BigInteger signedMessageToKey(
            byte[] message, Sign.SignatureData signatureData) throws SignatureException {
